...
while True:
    ...
    for iter in tags:
        ...
        company_name = inner_soup1.find("div", {"class":"company_name"})
        if company_name == None:
            company_name = inner_soup1.find("div", {"class":"company_name company_name--with-icon"})
        vac_dict["Employer"] = company_name.find("a").text if company_name else "Unknown";
